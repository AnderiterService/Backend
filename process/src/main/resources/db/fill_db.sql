...
INSERT INTO loan_information (balance_due, interest_rate, overdue_amount, sum, bki_id, client_id, date_from, date_to,
                              delay, final_date, role, status, type)
VALUES (1000.00, 5.0, 200.00, 1200.00, 1, 1, '2023-01-01', '2023-12-31', 1, '2024-01-01', 1, 1, 1),
       (1500.00, 6.0, 300.00, 1800.00, 2, 2, '2023-02-01', '2023-12-31', 2, '2024-02-01', 2, 2, 2),
       (2000.00, 7.0, 400.00, 2400.00, 3, 3, '2023-03-01', '2023-12-31', 3, '2024-03-01', 3, 1, 1),
       (1000.00, 5.0, 200.00, 1200.00, 1, 1, '2023-01-01', '2023-12-31', 1, '2024-01-01', 1, 1, 1),
       (1500.00, 5.5, 200.00, 1700.00, 2, 2, '2023-02-01', '2023-12-31', 2, '2024-02-01', 2, 2, 2),
       (2000.00, 6.0, 400.00, 2400.00, 3, 3, '2023-03-01', '2023-12-31', 3, '2024-03-01', 3, 1, 1),
       (2500.00, 6.5, 600.00, 3100.00, 4, 4, '2023-04-01', '2023-12-31', 4, '2024-04-01', 4, 2, 1),
       (3000.00, 7.0, 800.00, 3800.00, 5, 5, '2023-05-01', '2023-12-31', 5, '2024-05-01', 5, 2, 2),
       (3500.00, 7.5, 1000.00, 4500.00, 6, 6, '2023-06-01', '2023-12-31', 4, '2024-06-01', 6, 1, 1),
       (4000.00, 8.0, 1200.00, 5200.00, 7, 7, '2023-07-01', '2023-12-31', 3, '2024-07-01', 7, 2, 1);
...
INSERT INTO requests (pdn, sla_id, start_timestamp, status_id, uid, application_analysis, credit_history_analysis,
                      final_decision)
VALUES (1, TIMESTAMP '2023-01-01 12:00:00', 1234567890, 1, 1001, 'Analysis 1', 'Credit History 1', 'Decision 1'),
       (2, TIMESTAMP '2023-02-02 12:00:00', 2345678901,2, 1002, 'Analysis 2', 'Credit History 2', 'Decision 2'),
       (3, TIMESTAMP '2023-03-03 12:00:00', 3456789012,1, 1003, 'Analysis 3', 'Credit History 3', 'Decision 3'),
       (4, TIMESTAMP '2023-04-04 12:00:00', 4567890123, 1, 1004, 'Analysis 4', 'Credit History 4', 'Decision 4'),
       (5, TIMESTAMP '2023-05-05 12:00:00', 5678901234, 1, 1005, 'Analysis 5', 'Credit History 5', 'Decision 5'),
       (6, TIMESTAMP '2023-06-06 12:00:00', 6789012345, 1, 1006, 'Analysis 6', 'Credit History 6', 'Decision 6'),
       (7, TIMESTAMP '2023-07-07 12:00:00', 7890123456, 2, 1007, 'Analysis 7', 'Credit History 7', 'Decision 7'),
       (8, TIMESTAMP '2023-08-08 12:00:00', 8901234567, 1, 1008, 'Analysis 8', 'Credit History 8', 'Decision 8'),
       (9, TIMESTAMP '2023-09-09 12:00:00', 9012345678, 1, 1009, 'Analysis 9', 'Credit History 9', 'Decision 9'),
       (10, TIMESTAMP '2023-10-10 12:00:00', 1234567890, 2, 1010, 'Analysis 10', 'Credit History 10', 'Decision 10');
